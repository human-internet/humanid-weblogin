...
<body>
	...
	<a href="<?php echo site_url('login?token='.md5(time()));?>"><img src="<?php echo base_url('assets/images/anonymous-login.svg');?>" alt="Anonymous Login with humanID" height="27"></a>
</body>
</html>