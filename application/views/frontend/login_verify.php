<form method="post">
    ...
    <?php if($success):?>
        ...
        <div class="humanid-button humanid-button-vertical">
            ...
            <input type="hidden" class="directed-link" value="<?php echo site_url('client/success');?>">
        </div>
    <?php else:?>
        <div class="humanid-page-title">Verify Your Phone Number</div>
        <div class="humanid-content-text">
            <div class="humanid-text-info humanid-text-info-default">
                <p>Please enter the 4 digit code you received as SMS to <strong>+1 617 999 9999</strong>.</p>
        ...
        <div class="humanid-form-placement">
            ...
            <div class="humanid-form-placement__otp-resend">
                ...
                <a href="<?php echo site_url('login?token='.md5(time()));?>">Try Different Number</a>
                <input type="hidden" class="directed-link" value="<?php echo site_url('login/resend?token='.md5(time()));?>">
            </div>
        </div>
    <?php endif;?>
</form>