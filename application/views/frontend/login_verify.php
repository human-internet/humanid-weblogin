    ...
    <?php if($success):?>
        ...
        <div class="humanid-content-text">
            <div class="humanid-text-info humanid-text-info-default">
                ...
                <p><?php echo $lang->text->continue;?></p>
            </div>
        </div>
        <div class="humanid-button humanid-button-vertical">
            ...
            <button class="btn-humanid btn-humanid-secondary" type="button"><?php echo str_replace("{TIMER}",'<span class="timer-text"></span>',$lang->text->timer);?></button>
