...
<form method="post">
    ...
    <?php else: ?>
        ...
        <div class="humanid-content-text">
            <div class="humanid-text-info humanid-text-info-default">
                <p><?php echo str_replace(array("{COUNTRYCODE}", "{PHONE}"), array($row['dialcode'], $display_phone), $lang->text->verifyCode); ?>
                </p>
            ...
            <div class="humanid-form-placement__otp-verification">
                <?php if (isset($_GET['s']) && $_GET['s'] == 'm') { ?>
                    <div class="humanid-form-group" style="flex: 3">
                        <input type="tel" oninput="humanid.handleInputOtp(this, true)" maxlength="4" pattern="[0-9]*"
                            class="humanid-input-otp" name="code" id="single-factor-code-text-field"
                            autocomplete="one-time-code">
                    </div>
                    <button class="btn-humanid btn-humanid-primary btn-submit-otp" disabled type="submit" style="flex: 1">Submit
                    </button>
                <?php } else { ?>
                    <div class="humanid-form-group">
                        <input type="tel" oninput="humanid.handleInputOtp(this, false)"
                            onpaste="humanid.handlePasteOtp(this, event)" maxlength="4" pattern="[0-9]*"
                            class="humanid-input-otp" name="code" id="single-factor-code-text-field"
                            autocomplete="one-time-code">
                    </div>
                <?php } ?>
            ...
            <div class="humanid-form-placement__link">
                <div class="humanid-form-placement__link__wrapper">
                    ...
                    <a href="<?php echo site_url('login/resend?a=' . $app->id . '&t=' . $row['token'] . '&lang=' . $lang->id . '&s=' . $app->source . '&v=' . $version); ?>"
                        id="resend-link" class="resend-area humanid-link-blue-light"
