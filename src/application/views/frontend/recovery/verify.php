        ...
        <div class="humanid-form-placement__otp-verification">
            <?php for($i=1; $i<=$otpLength; $i++) {?>
                <div class="humanid-form-group">
                    <input type="tel" pattern="[0-9]*" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="humanid-input-otp" data-id="<?php echo $i;?>" maxlength="1" name="code[]" autofocus autocomplete="off">
                </div>
            <?php }?>
        </div>
